...
function XPC:BuildSingleToon()
  ...
  local function CreateHorizontalHeaderValues()
    ...
    hHeader.levelTime:SetPoint("TOPLEFT", (80 * 2) -10, -20)
    ...
    hHeader.xpPerHour:SetPoint("TOPLEFT", (80 * 3) -3, -20)
    ...
    hHeader.timeInCombat:SetPoint("TOPLEFT", (80 * 4) -18, -20)
    ...
    hHeader.percentInCombat:SetPoint("TOPLEFT", (80 * 5) -7, -20)
    hHeader.percentInCombat:SetText('Combat %')
    -- 6
    ...
    hHeader.percentXPQuests:SetPoint("TOPLEFT", (80 * 9) -17, -20)
    ...
    hHeader.kills:SetPoint("TOPLEFT", (80 * 10) +9, -20)
    ...
    hHeader.killsPerHour:SetPoint("TOPLEFT", (80 * 11) -8, -20)
    ...
    hHeader.XPFromMobs:SetPoint("TOPLEFT", (80 * 12) -2, -20)
    ...
    hHeader.percentXPMobs:SetPoint("TOPLEFT", (80 * 13) -14, -20)
    ...
    hHeader.dmgDone:SetPoint("TOPLEFT", (80 * 14) -10, -20)
    ...
    hHeader.HealsReceived:SetPoint("TOPLEFT", (80 * 17) -3, -20)
    ...
    hHeader.killsSolo:SetPoint("TOPLEFT", (80 * 18) -5, -20)
    ...
    hHeader.goldFromLoot:SetPoint("TOPLEFT", (80 * 20) -8, -20)
    ...
    hHeader.goldFromQuests:SetPoint("TOPLEFT", (80 * 21) -12, -20)
    ...
    hHeader.goldTotal:SetPoint("TOPLEFT", (80 * 23) -15, -20)
    ...
    hHeader.duelsWon:SetPoint("TOPLEFT", (80 * 25) -11, -20)
    ...
    hHeader.duelsLost:SetPoint("TOPLEFT", (80 * 26) -9, -20)
    ...
    hHeader.honorKills:SetPoint("TOPLEFT", (80 * 27) +9, -20)
    ...
    hHeader.honor:SetPoint("TOPLEFT", (80 * 28) +2, -20)
    ...
    hHeader.food:SetPoint("TOPLEFT", (80 * 29) +7, -20)
    ...
    hHeader.drink:SetPoint("TOPLEFT", (80 * 30) +6, -20)
    ...
    hHeader.bandages:SetPoint("TOPLEFT", (80 * 31) -7, -20)
    ...
    hHeader.healingPotions:SetPoint("TOPLEFT", (80 * 32) -12, -20)
    ...
    hHeader.manaPotions:SetPoint("TOPLEFT", (80 * 33) -10, -20)
    ...
    hHeader.potions:SetPoint("TOPLEFT", (80 * 35) +1, -20)
    ...
    hHeader.scrolls:SetPoint("TOPLEFT", (80 * 38) +2, -20)
    ...
    hHeader.flightPaths:SetPoint("TOPLEFT", (80 * 41) +7, -20)
    ...
    hHeader.timeOnTaxi:SetPoint("TOPLEFT", (80 * 42) -6, -20)
